...
Оцени оператора по трём группам критериев (0-100 каждая):

## 1. СТАНДАРТЫ (standard)
Проверь наличие и качество каждого этапа:
- Приветствие и установка контакта (назвал компанию, представился)
- Выявление потребности клиента (уточнил детали из заказа)
- Подтверждение деталей заказа (дата, сумма, адрес доставки, состав заказа)
- Презентация апсейла (предложил дополнительные продукты/услуги, объяснил выгоду)
- Обработка возражений (если были)
- Завершение и договорённости (следующие шаги, дата/время доставки)

## 2. ЛОЯЛЬНОСТЬ КЛИЕНТА (loyalty)
- Уровень удовлетворённости клиента на протяжении звонка
- Эмпатия оператора: выражение понимания, уважение к клиенту
- Персонализация: использование имени клиента, ссылка на прошлые покупки
- Повторное взаимодействие: намерение клиента вернуться, советы по лояльности
- Метрики доверия: уверенность речи, подходящий тон

## 3. ДОБРОЖЕЛАТЕЛЬНОСТЬ (kindness)
- Тон и манера общения: дружелюбие, профессионализм
- Гибкость и терпеливость: работа с возражениями без давления
- Ясность и понятность объяснений: избегание жаргона, чёткие инструкции
- Скорость реагирования: отвечал ли вовремя на вопросы клиента
- Активное слушание: не перебивал ли клиента
- Поддержка после подтверждения заказа: благодарность, пожелания
